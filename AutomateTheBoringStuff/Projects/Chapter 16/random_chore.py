#! python3
# random_chore.py - will randomly assign a chore to a set of individuals and email them once a day for a week
...
# The program will sleep for 24 hours and run through a loop for seven days.
for i in range(7):
    assignment()
    time.sleep(86400)
