...
def to_24_hour_clock(hours):
    ...
    return hours % 24
    ''' hours % is a bit different. 4%24 --> 4 i/o 0.1...'''
...
def time_to_utc(utc_offset, time):
    ...
    ### above is to compensate faster/slower than UTC, makes it same as UTC
    utc_time = to_24_hour_clock(utc0_actual_time)
    ### convert to the display on the clock by hour %24 in the function, %24 in time
...
###convert to the display on the clock by hour %24 in the function, %24 in time
### is different from usual %.look at (-7,6) -> returns -1 then become 23 (24-1)
